...
const TrainerApplication = ({ onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Submitting trainer application:', applicationData);
      ...
      if (result.success) {
        navigate('/notification', {
          state: {
            ...
            message: 'Your trainer application has been submitted and is under review. You will receive an email notification within 3-5 business days.',
  ...
  return (
    <div className="application-form">
      <div className="form-header">
        ...
        <p>Join our team as a professional trainer</p>
      </div>
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                ...
                placeholder="e.g., Computer Training Instructor"
                required
              />
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              rows="3"
              placeholder="List your areas of expertise (separate with commas)"
            />
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="file-input"
            />
            <small>Upload relevant certificates (PDF, JPG, PNG, max 10MB total)</small>
          </div>
        </div>
